...
import br.com.core.softpet.ui.fornecedor.*;
...
import br.com.core.softpet.util.model.table.ModeloTabelaFornecedor;
import br.com.core.softpet.util.model.table.colunas.ModeloColuna;
import javax.swing.JOptionPane;

public class FormListaFornecedor extends javax.swing.JInternalFrame implements IFormularioLista {
    ...
    private void initComponents() {
        ...
        pnlDados.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Lista de fornecedores cadastrados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 72, 255))); // NOI18N
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        new FormFornecedor(acaoTela.INSERIR, this, null);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == -1) {
            ...
            fornecedor = (Fornecedor) fornecedorController.procurarPorId("Fornecedor.findById", "id", id);
            new FormFornecedor(acaoTela.ALTERAR, this, fornecedor);
        }
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            fornecedor = (Fornecedor) fornecedorController.procurarPorId("Fornecedor.findById", "id", id);
            int op = JOptionPane.showConfirmDialog(null, "Você deseja mesmo excluir este registro: " + fornecedor.getNome()+ " ?",
                    "Questão", JOptionPane.YES_NO_OPTION);
            if (op == 0) {
                fornecedorController.deletar(fornecedor);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            fornecedor = (Fornecedor) fornecedorController.procurarPorId("Fornecedor.findById", "id", id);
            new FormFornecedor(acaoTela.PESQUISAR, this, fornecedor);
        }
    ...
    public void montarTabela(EnumTipoPesquisa tipoPesquisa) {
        modeloTabela = new ModeloTabelaFornecedor(tipoPesquisa, txtBuscaRegistro.getText());
        this.tblDados.setModel(modeloTabela);
        ModeloColuna.setarColunas(tblDados, 100, 250, 250, 250);
    }
}
