...
import br.com.core.softpet.util.model.table.ModeloTabelaCategoria;
import br.com.core.softpet.util.model.table.colunas.ModeloColuna;
import javax.swing.JOptionPane;

public class FormListaCategoria extends javax.swing.JInternalFrame implements IFormularioLista {

    private ModeloTabelaCategoria modeloTabela;
    ...
    private void initComponents() {
        ...
        pnlDados.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Lista de categorias cadastradas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 72, 255))); // NOI18N
        ...
        pnlDados.getAccessibleContext().setAccessibleName("Lista de categorias cadastradas");
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        new FormCategoria(acaoTela.INSERIR, this, null);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == -1) {
            ...
            categoria = (Categoria) categoriaController.procurarPorId("Categoria.findById", "id", id);
            new FormCategoria(acaoTela.ALTERAR, this, categoria);
        }
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            categoria = (Categoria) categoriaController.procurarPorId("Categoria.findById", "id", id);
            int op = JOptionPane.showConfirmDialog(null, "Você deseja mesmo excluir este registro: " + categoria.getDescricao() + " ?",
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            categoria = (Categoria) categoriaController.procurarPorId("Categoria.findById", "id", id);
            new FormCategoria(acaoTela.PESQUISAR, this, categoria);
        }
    ...
    public void montarTabela(EnumTipoPesquisa tipoPesquisa) {
        modeloTabela = new ModeloTabelaCategoria(tipoPesquisa, txtBuscaRegistro.getText());
        this.tblDados.setModel(modeloTabela);
        ModeloColuna.setarColunas(tblDados, 100, 400, 500);
    }
}
