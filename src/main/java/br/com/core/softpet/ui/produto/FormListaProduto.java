...
import br.com.core.softpet.ui.produto.*;
...
import br.com.core.softpet.util.model.table.ModeloTabelaProduto;
import br.com.core.softpet.util.model.table.colunas.ModeloColuna;
import javax.swing.JOptionPane;

public class FormListaProduto extends javax.swing.JInternalFrame implements IFormularioLista {
    ...
    private void initComponents() {
        ...
        pnlDados.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Lista de produtos cadastrados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 72, 255))); // NOI18N
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        new FormProduto(acaoTela.INSERIR, this, null);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == -1) {
            ...
            produto = (Produto) produtoController.procurarPorId("Produto.findById", "id", id);
            new FormProduto(acaoTela.ALTERAR, this, produto);
        }
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            produto = (Produto) produtoController.procurarPorId("Produto.findById", "id", id);
            int op = JOptionPane.showConfirmDialog(null, "Você deseja mesmo excluir este registro: " + produto.getDescricao() + " ?",
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            produto = (Produto) produtoController.procurarPorId("Produto.findById", "id", id);
            new FormProduto(acaoTela.PESQUISAR, this, produto);
        }
    ...
    public void montarTabela(EnumTipoPesquisa tipoPesquisa) {
        modeloTabela = new ModeloTabelaProduto(tipoPesquisa, txtBuscaRegistro.getText());
        this.tblDados.setModel(modeloTabela);
        ModeloColuna.setarColunas(tblDados, 100, 500, 500);
    }
}
