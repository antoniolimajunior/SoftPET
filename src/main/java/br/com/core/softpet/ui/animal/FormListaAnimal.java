...
import br.com.core.softpet.util.model.table.ModeloTabelaAnimal;
import br.com.core.softpet.util.model.table.colunas.ModeloColuna;
import javax.swing.JOptionPane;

public class FormListaAnimal extends javax.swing.JInternalFrame implements IFormularioLista {

    private ModeloTabelaAnimal modeloTabela;
    ...
    private void initComponents() {
        ...
        pnlDados.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Lista de animais cadastrados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 72, 255))); // NOI18N
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        new FormAnimal(acaoTela.INSERIR, this, null);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == -1) {
            ...
            animal = (Animal) animalController.procurarPorId("Animal.findById", "id", id);
            new FormAnimal(acaoTela.ALTERAR, this, animal);
        }
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            animal = (Animal) animalController.procurarPorId("Animal.findById", "id", id);
            int op = JOptionPane.showConfirmDialog(null, "Você deseja mesmo excluir este registro: " + animal.getNome()+ " ?",
                    "Questão", JOptionPane.YES_NO_OPTION);
            if (op == 0) {
                animalController.deletar(animal);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            animal = (Animal) animalController.procurarPorId("Animal.findById", "id", id);
            new FormAnimal(acaoTela.PESQUISAR, this, animal);
        }
    ...
    public void montarTabela(EnumTipoPesquisa tipoPesquisa) {
        modeloTabela = new ModeloTabelaAnimal(tipoPesquisa, txtBuscaRegistro.getText());
