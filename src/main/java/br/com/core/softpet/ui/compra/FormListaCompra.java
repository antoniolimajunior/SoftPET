...
import br.com.core.softpet.ui.compra.*;
...
import br.com.core.softpet.util.model.table.ModeloTabelaCompra;
import br.com.core.softpet.util.model.table.colunas.ModeloColuna;
import javax.swing.JOptionPane;

public class FormListaCompra extends javax.swing.JInternalFrame implements IFormularioLista {

    private ModeloTabelaCompra modeloTabela;
    ...
    private void initComponents() {
        ...
        pnlDados.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Lista de compras cadastradas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 72, 255))); // NOI18N
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        new FormCompra(acaoTela.INSERIR, this, null);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == -1) {
            ...
            compra = (Compra) compraController.procurarPorId("Compra.findById", "id", id);
            new FormCompra(acaoTela.ALTERAR, this, compra);
        }
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            compra = (Compra) compraController.procurarPorId("Compra.findById", "id", id);
            int op = JOptionPane.showConfirmDialog(null, "Você deseja mesmo excluir este registro: " + compra.getFornecedor()+ " ?",
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            compra = (Compra) compraController.procurarPorId("Compra.findById", "id", id);
            new FormCompra(acaoTela.PESQUISAR, this, compra);
        }
    ...
    public void montarTabela(EnumTipoPesquisa tipoPesquisa) {
        modeloTabela = new ModeloTabelaCompra(tipoPesquisa, txtBuscaRegistro.getText());
