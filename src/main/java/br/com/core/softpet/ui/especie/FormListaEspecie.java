...
import br.com.core.softpet.util.model.table.ModeloTabelaEspecie;
import br.com.core.softpet.util.model.table.colunas.ModeloColuna;
import javax.swing.JOptionPane;

public class FormListaEspecie extends javax.swing.JInternalFrame implements IFormularioLista {

    private ModeloTabelaEspecie modeloTabela;
    ...
    private void initComponents() {
        ...
        pnlDados.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Lista de espécies cadastradas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 72, 255))); // NOI18N
        ...
        pnlDados.getAccessibleContext().setAccessibleName("Lista de espécies cadastradas");
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        new FormEspecie(acaoTela.INSERIR, this, null);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == -1) {
            ...
            especie = (Especie) especieController.procurarPorId("Especie.findById", "id", id);
            new FormEspecie(acaoTela.ALTERAR, this, especie);
        }
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            especie = (Especie) especieController.procurarPorId("Especie.findById", "id", id);
            int op = JOptionPane.showConfirmDialog(null, "Você deseja mesmo excluir este registro: " + especie.getDescricao() + " ?",
                    "Questão", JOptionPane.YES_NO_OPTION);
            if (op == 0) {
                especieController.deletar(especie);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (linha == -1) {
            ...
            int id = this.modeloTabela.retornaId(linha);
            especie = (Especie) especieController.procurarPorId("Especie.findById", "id", id);
            new FormEspecie(acaoTela.PESQUISAR, this, especie);
        }
    ...
    public void montarTabela(EnumTipoPesquisa tipoPesquisa) {
        modeloTabela = new ModeloTabelaEspecie(tipoPesquisa, txtBuscaRegistro.getText());
        this.tblDados.setModel(modeloTabela);
        ModeloColuna.setarColunas(tblDados, 100, 400);
    }
}
